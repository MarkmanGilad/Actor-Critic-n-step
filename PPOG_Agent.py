...
class PPO_Agent:
    ...
    def learn(self, next_val):
        '''
        שינוי של האלגוריתם לפי גלעד מרקמן
        אם היחס חורג מהאזור הבטוח והכיוון של העדכון היה בכיוון הנכון - פונקציית הטעות מקבלת מספר קבוע והנגזר מתאפסת - אין עדכון.
        בכל מקרה אחר מבצעים עדכון בדומה לנוסחה הרגילה של
